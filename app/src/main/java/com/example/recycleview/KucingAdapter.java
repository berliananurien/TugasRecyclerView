...
public class KucingAdapter extends RecyclerView.Adapter<KucingAdapter.KucingViewHolder> {
    ...
    int images[];
    Context context;
    public KucingAdapter(Context ct, String s1[], String s2[],
                         String s3[], int img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
    ...
    @NonNull
    @Override
    public KucingAdapter.KucingViewHolder
    onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater =
                LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.item_kucing,
                parent, false);
        return new KucingViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull KucingAdapter.KucingViewHolder holder, int position) {
    ...
    public class KucingViewHolder extends RecyclerView.ViewHolder {
        ...
        public KucingViewHolder(View itemView) {
            ...
            star = itemView.findViewById(R.id.love);
